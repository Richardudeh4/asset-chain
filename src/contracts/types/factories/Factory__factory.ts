...
const _abi = [
  ...
  {
    inputs: [],
    name: "BridgeTypeInvalidImplementation",
    type: "error",
  },
  {
    inputs: [
    ...
    name: "BridgeZeroAddress",
    type: "error",
  },
  {
    inputs: [],
    name: "DuplicateImplementations",
    type: "error",
  },
  {
    inputs: [],
  ...
  {
    inputs: [],
    name: "InvalidOffsetLimit",
    type: "error",
  },
  {
    inputs: [],
    name: "NoBridgesByToken",
    type: "error",
  },
  {
    inputs: [],
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "address",
        name: "bridgeAssistCircleMintBurnImplementation_",
        type: "address",
      },
    ],
