...
export class BridgeAssist__factory {
  static readonly abi = _abi;
  static createInterface(): BridgeAssistInterface {
    return new Interface(_abi) as BridgeAssistInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): BridgeAssist {
    return new Contract(address, _abi, runner) as unknown as BridgeAssist;
  }
}
