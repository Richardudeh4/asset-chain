  ...
  export function Faqs() {
    return (
      <Accordion type="single" collapsible className="w-full flex flex-col space-y-2.5">
        <AccordionItem 
          value="item-1" 
          className="border border-[#1A2739] border-b-1 first:rounded-t-[5px] last:rounded-b-[5px] last:border-b  rounded-[5px]  bg-transparent py-2 px-4.5"
        >
        ...
        <AccordionItem 
          value="item-2"  
          className="border border-[#1A2739] border-b-1 first:rounded-t-[5px] last:rounded-b-[5px] rounded-[5px]  last:border-b bg-transparent py-2 px-4.5"
        >
